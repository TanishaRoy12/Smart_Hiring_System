...
def send_email(to_email, subject, message):
    try:
        ...
        sender_email = "smarthiringsystem2024@gmail.com"    
        sender_password = "ngpx aerc otlw vxxj"  
...
connection = mysql.connector.connect(host='sql12.freesqldatabase.com', user='sql12785081', password='ZFvCnxNeA4',database='sql12785081')
